 ...
 */
package org.ankus.web.designer;
...
import org.ankus.core.exception.ParsingException;
import org.ankus.core.exception.PersistenceException;
import org.ankus.core.exception.WorkflowException;
import org.ankus.model.opengraph.Opengraph;
import org.ankus.model.rest.Engine;
import org.ankus.model.rest.Error;
import org.ankus.model.rest.HadoopCluster;
import org.ankus.model.rest.NodeType;
import org.ankus.model.rest.Response;
import org.ankus.model.rest.State;
import org.ankus.model.rest.Tree;
import org.ankus.model.rest.TreeType;
import org.ankus.model.rest.Visualization;
import org.ankus.model.rest.VisualizationHistory;
import org.ankus.model.rest.Workflow;
import org.ankus.model.rest.WorkflowHistory;
import org.ankus.model.rest.WorkflowStatusType;
import org.ankus.provider.engine.HistoryService;
import org.ankus.provider.engine.JobService;
//import org.ankus.provider.engine.VisualizationJobService;
import org.ankus.util.DateUtils;
import org.ankus.util.ExceptionUtils;
import org.ankus.util.JVMIDUtils;
import org.ankus.util.JaxbUtils;
...
import org.ankus.web.member.MemberService;
import org.ankus.web.security.SessionUtils;
import org.ankus.web.tree.TreeService;
//import org.ankus.web.visualization.VisualRepository;
...
public class DesignerServiceImpl extends LocaleSupport implements DesignerService {
    ...
    public static String WORKFLOW_JAXB_PACKAGE_NAME = "org.ankus.model.workflow";
    //OpenGraph XML의 JAXB Package.
    public static String OPENGRAPH_JAXB_PACKAGE = "org.ankus.model.opengraph";
    ...
    public Workflow regist(String parentTreeId, String openGraphXml, String username) {
        try {
            ...
            org.ankus.model.workflow.Workflow wf = openGraphMarshaller.unmarshal(openGraphXml);
