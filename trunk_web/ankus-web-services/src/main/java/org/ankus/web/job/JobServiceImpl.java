...
@Service
public class JobServiceImpl implements org.ankus.web.job.JobService {
    ...
    public String regist(long engineId, String jobName, long workflowId, String cronExpression, HashMap vars) {
        ...
        org.ankus.provider.engine.JobService jobService = getJobService(engine);
     ...
     */
    private org.ankus.provider.engine.JobService getJobService(String url) {
        HttpInvokerProxyFactoryBean factoryBean = new HttpInvokerProxyFactoryBean();
        factoryBean.setServiceUrl(url);
        factoryBean.setServiceInterface(org.ankus.provider.engine.JobService.class);
        HttpComponentsHttpInvokerRequestExecutor httpInvokerRequestExecutor = new HttpComponentsHttpInvokerRequestExecutor();
        factoryBean.setHttpInvokerRequestExecutor(httpInvokerRequestExecutor);
        factoryBean.afterPropertiesSet();
        return (org.ankus.provider.engine.JobService) factoryBean.getObject();
    }
     ...
     * @return Remote Workflow Engine Service
     */
    private org.ankus.provider.engine.JobService getJobService(Engine engine) {
