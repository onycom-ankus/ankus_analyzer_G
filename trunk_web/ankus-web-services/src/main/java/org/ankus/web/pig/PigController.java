...
import org.ankus.web.designer.OpenGraphMarshaller;
...
public class PigController extends LocaleSupport {
    ...
    public Response run(@RequestParam(defaultValue = "0") Long engineId,
        ...
        // Convert JSON to Pig
        org.ankus.model.rest.Pig pig = objectMapper.readValue(body, new org.codehaus.jackson.type.TypeReference<org.ankus.model.rest.Pig>() {
        });
