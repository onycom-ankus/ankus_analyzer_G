...
public class HiveAdminController extends LocaleSupport {
     ...
     *
     * @return HTTP REST Response (성공적으로 목록을 조회한 경우 {@link org.ankus.model.rest.Response#getList()} 를 통해 목록을 얻을 수 있다).
     */
    ...
    /**
     * Hive Server를 추가한다. Hive Server의 이름({@link org.ankus.model.rest.HiveServer#getName()}의 양쪽 끝에 공백 문자를 포함하는 경우
     * 자동으로 trim 처리한다.
     *
     * @param hiveServer 추가할 Hive Server
     * @return HTTP REST Response (성공적으로 추가한 경우 {@link org.ankus.model.rest.Response#isSuccess()}가 <tt>true</tt>
     */
    ...
    /**
     * Hive Server를 삭제한다. 삭제를 위해서 Hive Server의 식별자를 설정하는 {@link org.ankus.model.rest.HiveServer#setId(long)} 메소드를 이용하도록 한다.
     *
     * @param hiveServer 삭제할 Hive Server
     * @return HTTP REST Response (성공적으로 삭제한 경우 {@link org.ankus.model.rest.Response#isSuccess()}가 <tt>true</tt>
     */
