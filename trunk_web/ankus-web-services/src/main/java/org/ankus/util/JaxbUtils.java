...
public class JaxbUtils {
     ...
     * <p>
     * <pre>
     * Marshaller marshaller = JaxbUtils.createMarshaller("org.ankus.domain.request");
     * </pre>
     * </p>
     ...
     * <p>
     * <pre>
     * Unmarshaller unmarshaller = JaxbUtils.createUnmarshaller("org.ankus.domain.request");
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link javax.xml.bind.JAXBContext#createMarshaller()} 및 {@link javax.xml.bind.JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
     ...
     * <pre>
     * Request requst = ...;
     * JaxbUtils.marshal(request, "org.ankus.domain.request", "/home/tester/test.xml", "/home/tester/test.xsd");
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link javax.xml.bind.JAXBContext#createMarshaller()} 및 {@link javax.xml.bind.JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
     ...
     * <pre>
     * Request requst = ...;
     * JaxbUtils.marshal(request, "org.ankus.domain.request", "/home/tester/test.xml");
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link javax.xml.bind.JAXBContext#createMarshaller()} 및 {@link javax.xml.bind.JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
     ...
     * String xml = JaxbUtils.marshal("org.ankus.domain.request", request);
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link javax.xml.bind.JAXBContext#createMarshaller()} 및 {@link javax.xml.bind.JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
     *
     * @param packageName 패키지명 (예; "<tt>org.ankus.sal.domain.request</tt>")
     ...
     * <p>
     * <pre>
     * Request request = (Request) JaxbUtils.marshal("org.ankus.domain.request", "/home/tester/xml", "test.xml");
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link javax.xml.bind.JAXBContext#createMarshaller()} 및 {@link javax.xml.bind.JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
     ...
     * Request request = (Request) JaxbUtils.marshal("org.ankus.domain.request", xml);
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link javax.xml.bind.JAXBContext#createMarshaller()} 및 {@link javax.xml.bind.JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
     ...
     * Request request = (Request) JaxbUtils.marshal("org.ankus.domain.request", inputStream);
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link javax.xml.bind.JAXBContext#createMarshaller()} 및 {@link javax.xml.bind.JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
     ...
     * Request request = (Request) JaxbUtils.marshal("org.ankus.domain.request", reader);
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link javax.xml.bind.JAXBContext#createMarshaller()} 및 {@link javax.xml.bind.JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
