...
public class FileSystemUtils {
     ...
     *
     * @param path 경로
     * @throws org.ankus.core.exception.FileSystemException 디렉토리를 생성할 수 없거나, 존재하지만 디렉토리가 아니라 파일인 경우
     */
...
//            FileSystem fs = path.getFileSystem(conf);
     ...
     * @return 파일의 내용
     * @throws org.ankus.core.exception.FileSystemException 파일을 로딩할 수 없는 경우
     */
     ...
     * @throws org.ankus.core.exception.FileSystemException 파일을 저장할 수 없는 경우
     */
