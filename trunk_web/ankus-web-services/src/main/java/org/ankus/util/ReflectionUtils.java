...
public class ReflectionUtils {
     ...
     * @throws org.ankus.core.exception.WorkflowException 클래스를 찾을 수 없는 경우
     ...
     * <p/><pre>
     * Class clazz = ReflectionUtils.resolveClassName("org.ankus.util.ReflectionUtils",
     * Thread.currentThread().getContextClassLoader());
     * String className = clazz.getName(); // Name is "org.ankus.util.ReflectionUtils"
     * </pre>
     *
     * @param className   클래스명
     * @param classLoader 사용할 클래스 로더(<tt>null</tt>이 될 수 있음)
    ...
    /**
     * 지정한 클래스의 qualified name을 반환한다. "<tt>ClassUtils</tt>"의 경우 "org.ankus.manager.util.ClassUtils"를 반환한다.
     *
     * @param clazz 클래스
     ...
     * @return 호출 결과
     * @throws org.ankus.core.exception.WorkflowException 메소드를 호출할 수 없는 경우
     */
     ...
     * @return 인스턴스
     * @throws org.ankus.core.exception.WorkflowException 인스턴스를 생성할 수 없는 경우
     */
     ...
     * @return Setter
     * @throws org.ankus.core.exception.WorkflowException Setter를 반환할 수 없는 경우
     */
     ...
     * @param fieldName 인스턴스 필드
     * @return Getter
     * @throws org.ankus.core.exception.WorkflowException Getter를 반환할 수 없는 경우
     */
