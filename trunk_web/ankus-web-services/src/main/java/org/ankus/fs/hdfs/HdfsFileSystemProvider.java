...
import org.ankus.util.HdfsUtils;
...
import static org.ankus.model.rest.Context.AUTORITY;
import static org.ankus.model.rest.Context.HADOOP_CLUSTER;
...
//        System.out.printf("HdfsFileSystemProvider====>[%s]\n", this.authority.getName());
        ...
        try {
        	if(this.authority.getSecurityLevel()==org.ankus.model.rest.SecurityLevel.SUPER)
        	{
